...
function verificacaoCodigo(req, res) {
  ...
  usuarioModel
    .verificacaoCodigo(email, codigo)
    .then((resultado) => {
      ...
      if (resultado.changedRows == 0) {
        ...
        const mg = mailgun.client({
          ...
          key:
            ...
            "c4544799b9ef2a3d60fc523305872137-181449aa-8b230eec",
        });

        mg.messages
          .create("sandboxea8ad1cb90ce4f2dab9f3b084922242a.mailgun.org", {
...
async function atualizarInfosUsuario(req, res) {
  try {
    const fkCompanhia = req.params.fkCompanhia;
    const { idUsuario, nome, senha, email } = req.body;
    ...
    const result = await usuarioModel.atualizarInfosUsuario(
      fkCompanhia,
      newInfos
    );
    res.status(201).json(result);
